...
<%@ page import="com.wgcq.beans.WorkerFilePlus" %>
...
<html class="x-admin-sm">
    ...
    <%
        ...
        List<WorkerFilePlus> fileList = fileService.getWorkerFilePlusList();
        sqlSession.close();
                    ...
                    <div class="layui-card">
                        <div class="layui-card-header">
                            <button class="layui-btn"
                                    onclick="xadmin.open('添加养员档案','/page/fileManagement/form/addFile.jsp?action=worker',800,600)">
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <c:forEach items="${fileList}" var="file">
                                    <tr>
                                        ...
                                        <td>${file.getName()}</td>
                                        <td class="td-status">
                                            <span class="layui-btn layui-btn-normal" onclick="xadmin.open('查看员工档案','/page/fileManagement/form/viewWorkerFile.jsp?id='+${file.getId()},800,600)">查看详情</span>
                                        </td>
                                        <td class="td-manage ">

                                            <button type="button" class="layui-btn layui-btn-primary"
                                                    onclick="xadmin.open('更新员工档案','/page/fileManagement/form/updateFile.jsp?id='+${file.getId()},800,600)">
